...
/**
 * Verifies migration v46 -> v47: the `artist_images` cache table is created
...
class MigrationV46V47Test {

    private val DB_NAME = "migration-v46v47-test"
    ...
    fun `artist_images table is created with NOCASE primary key and stores photos`() {
        helper.createDatabase(DB_NAME, 46).use { db ->
            db.execSQL(
                """
        ...
        val migrated = helper.runMigrationsAndValidate(
            DB_NAME, 47, true, StashDatabase.MIGRATION_46_47,
        )
